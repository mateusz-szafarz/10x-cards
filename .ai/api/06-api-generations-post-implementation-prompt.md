...
<implementation_plan>
@.ai/api/05-api-generations-post-implementation-plan.md
</implementation_plan>
...
1. Przeanalizuj plan wdrożenia:
    - Określenie metody HTTP (GET, POST, PUT, DELETE itp.) dla punktu końcowego.
    ...
    - Zwrócenie uwagi na wszelkie szczególne wymagania dotyczące walidacji lub obsługi błędów.
...
5. Dokumentacja:
    - Dodaj jasne komentarze, aby wyjaśnić złożoną logikę lub ważne decyzje (dokumentacja w kodzie zawsze w języku
      angielskim)
